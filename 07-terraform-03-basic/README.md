...
### Ответ:
[Конфиги terraform](terraform-workspaces)
```PS
PS C:\HomeWork-netology\07-terraform-03-basic\terraform-workspaces> terraform workspace list 
  default
* prod
  stage
```
```PS
PS C:\HomeWork-netology\07-terraform-03-basic\terraform-workspaces> terraform plan
var.yc_token
  Enter a value: 1111
